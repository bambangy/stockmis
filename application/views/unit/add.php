<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo ($view == true) ? "View" : (($edit) ? "Edit" : "Add")  ?> Unit</li>
    </ol>
</section>
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" action="<?php echo base_url($form_action); ?>" method="post">
                    ...
                    <div class="box-footer">
                        <a href="<?php echo ($edit == true ? base_url('unit/view/'.set_value('id', (isset($form_data->id)?$form_data->id : ''))) : base_url('unit')); ?>" class="btn btn-default">Cancel</a>
                        <?php if($view == false){ ?>
                            <button type="submit" class="btn btn-info"><i class="fa fa-floppy-o"></i> Save</button>
                        <?php }else{ ?>
                            <a href="<?php echo base_url('unit/edit/'.(isset($form_data->id)?$form_data->id : '')); ?>" class="btn btn-success"><i class="fa fa-pencil"></i> Edit</a>
                        <?php }
                        if($edit == true){
                         ?>
...
if($edit == true){
    ?>
    <form id="delete-form" action="<?php echo base_url('unit/delete'); ?>" method="post">
        <input type="hidden" name="id" value="<?php echo set_value('id', isset($form_data->id)?$form_data->id : ''); ?>" >
    </form>
    <?php
}
